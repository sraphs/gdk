...
// For example, "github.com/sraphs/gdk/secrets/Encrypt".
...
// For example, "github.com/sraphs/gdk/secrets/latency".
//
...
const pkgName = "github.com/sraphs/gdk/secrets"
...
var errClosed = gdkerr.Newf(gdkerr.FailedPrecondition, nil, "secrets: Keeper has been closed")
...
// https://sraphs.github.io/gdk/concepts/as/ for background information and the
...
func (k *Keeper) ErrorAs(err error, i interface{}) bool {
	return gdkerr.ErrorAs(err, i, k.k.ErrorAs)
}
...
func wrapError(k *Keeper, err error) error {
	...
	return gdkerr.New(k.k.ErrorCode(err), err, 2, "secrets")
}
