...
var errorCodes = map[int]gdkerr.ErrorCode{
	amqp.NotFound:           gdkerr.NotFound,
	amqp.PreconditionFailed: gdkerr.FailedPrecondition,
	// These next indicate a bug in our driver, not the user's code.
	amqp.SyntaxError:    gdkerr.Internal,
	amqp.CommandInvalid: gdkerr.Internal,
	amqp.InternalError:  gdkerr.Internal,
	amqp.NotImplemented: gdkerr.Unimplemented,
	amqp.ChannelError:   gdkerr.FailedPrecondition, // typically channel closed
}
