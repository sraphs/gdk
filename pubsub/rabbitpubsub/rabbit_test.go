...
func TestErrorCode(t *testing.T) {
	for _, test := range []struct {
		in   error
		want gdkerr.ErrorCode
	}{
		{nil, gdkerr.Unknown},
		{&os.PathError{}, gdkerr.Unknown},
		{&amqp.Error{Code: amqp.SyntaxError}, gdkerr.Internal},
		{&amqp.Error{Code: amqp.NotImplemented}, gdkerr.Unimplemented},
		{&amqp.Error{Code: amqp.ContentTooLarge}, gdkerr.Unknown},
	} {
