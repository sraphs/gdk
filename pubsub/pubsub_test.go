...
func (*driverTopic) ErrorCode(error) gdkerr.ErrorCode { return gdkerr.Unknown }
...
func (*driverSub) ErrorCode(error) gdkerr.ErrorCode { return gdkerr.Internal }
...
func (*failTopic) ErrorCode(error) gdkerr.ErrorCode { return gdkerr.Unknown }
...
func (erroringTopic) ErrorCode(error) gdkerr.ErrorCode                   { return gdkerr.AlreadyExists }
...
func (erroringSubscription) ErrorCode(error) gdkerr.ErrorCode               { return gdkerr.AlreadyExists }
...
func TestOpenCensus(t *testing.T) {
	...
	diff := octest.Diff(te.Spans(), te.Counts(), "github.com/sraphs/gdk/pubsub", "github.com/sraphs/gdk/pubsub", []octest.Call{
		{Method: "driver.Topic.SendBatch", Code: gdkerr.OK},
		{Method: "Topic.Send", Code: gdkerr.OK},
		{Method: "Topic.Shutdown", Code: gdkerr.OK},
		{Method: "driver.Subscription.ReceiveBatch", Code: gdkerr.OK},
		{Method: "Subscription.Receive", Code: gdkerr.OK},
		{Method: "driver.Subscription.SendAcks", Code: gdkerr.OK},
		{Method: "Subscription.Shutdown", Code: gdkerr.OK},
		{Method: "Subscription.Receive", Code: gdkerr.FailedPrecondition},
	})
	if diff != "" {
		t.Error(diff)
	}
