...
//
// See https://github.com/sraphs/gdk/howto/runtimevar/ for a detailed how-to guide.
//
...
//
// This API collects an OpenCensus metric "github.com/sraphs/gdk/runtimevar/value_changes",
...
const pkgName = "github.com/sraphs/gdk/runtimevar"
...
func newVar(w driver.Watcher) *Variable {
	...
	v := &Variable{
		...
		changed:          changed,
		lastWatch:        changed,
		lastErr:          gdkerr.Newf(gdkerr.FailedPrecondition, nil, "no value yet"),
	}
	go v.background(ctx)
	return v
}
...
var ErrClosed = gdkerr.Newf(gdkerr.FailedPrecondition, nil, "Variable has been Closed")
...
func wrapError(w driver.Watcher, err error) error {
	...
	return gdkerr.New(w.ErrorCode(err), err, 2, "runtimevar")
}
...
// decoding an encrypted message (https://godoc.org/github.com/sraphs/gdk/secrets).
//
...
// "RUNTIMEVAR_KEEPER_URL". See https://godoc.org/github.com/sraphs/gdk/secrets#OpenKeeper
// for more details.
